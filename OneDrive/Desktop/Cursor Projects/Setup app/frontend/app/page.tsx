        ...
        <div className="rounded-2xl bg-gray-900/80 border border-gray-800 p-8 shadow-2xl backdrop-blur-xl">
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Link
              ...
              className="group flex flex-col items-center justify-center rounded-xl border-2 border-purple-500/30 bg-gradient-to-br from-purple-500/10 to-purple-600/5 p-8 transition-all hover:border-purple-500 hover:shadow-lg hover:shadow-purple-500/20 hover:scale-105"
            >
              ...
              <div className="mt-4 px-4 py-2 rounded-full bg-purple-500/20 text-purple-400 text-sm font-semibold uppercase tracking-wider">
                Manager →
              </div>
            </Link>
          </div>

        ...
        <form onSubmit={handleSubmit} className="rounded-2xl bg-gray-900/80 border border-gray-800 p-8 shadow-2xl backdrop-blur-xl">
              ...
              {lastSubmission && (
                <div className="rounded-xl bg-gradient-to-r from-red-500/10 to-orange-500/10 border border-red-500/30 p-6">
                  <p className="mb-4 font-semibold text-white text-lg">
                    🏁 Found previous setup from {lastSubmission.createdAt ? new Date(lastSubmission.createdAt).toLocaleDateString() : 'last session'}
                  </p>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              ...
              <div>
                <label className={labelClass}>Gear Ratio (Shifter Only)</label>
                <input
                  type="text"
            ...
            <div className="space-y-6">
              ...
              {hasSetupChanged === false && (
                <div className="rounded-xl bg-green-500/10 border border-green-500/30 p-4 mb-6">
                  <p className="text-green-400 font-semibold">✓ Using your previous setup. Just update session type and submit!</p>
                </div>
              )}

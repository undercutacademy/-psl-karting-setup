    ...
    const dummySubmissions = [
        {
            userId: driver.id,
            teamId: team.id,
            sessionType: client_1.SessionType.Practice1,
            classCode: client_1.ClassCode.Sr,
            track: 'Orlando',
            ...
            axle: 'M',
            rearHubsMaterial: client_1.RearHubsMaterial.Aluminium,
            rearHubsLength: '90mm',
            frontHeight: client_1.FrontHeight.Standard,
            backHeight: client_1.BackHeight.Medium,
            frontHubsMaterial: client_1.FrontHubsMaterial.Magnesium,
            frontBar: client_1.FrontBar.Standard,
            spindle: client_1.Spindle.Standard,
            caster: 'Neutral',
        ...
        },
        {
            userId: driver.id,
            teamId: team.id,
            sessionType: client_1.SessionType.Qualifying,
            classCode: client_1.ClassCode.Sr,
            track: 'Orlando',
            championship: 'Florida Winter Tour',
            division: 'KA100 Sr',
            ...
            backHeight: client_1.BackHeight.Medium,
            frontHubsMaterial: client_1.FrontHubsMaterial.Magnesium,
            frontBar: client_1.FrontBar.Nylon,
            spindle: client_1.Spindle.Standard,
            caster: 'Neutral',
            seatPosition: 'Standard',
            lapTime: '54.912',
        ...
        },
        {
            userId: driver.id,
            teamId: team.id,
            sessionType: client_1.SessionType.Final,
            classCode: client_1.ClassCode.Sr,
            track: 'Orlando',
            championship: 'Florida Winter Tour',
            division: 'KA100 Sr',
            ...
            chassis: 'BirelArt RY30',
            axle: 'M',
            rearHubsMaterial: client_1.RearHubsMaterial.Magnesium,
            rearHubsLength: '90mm',
            frontHeight: client_1.FrontHeight.Standard,
            backHeight: client_1.BackHeight.Medium,
            frontHubsMaterial: client_1.FrontHubsMaterial.Magnesium,

...
async function main() {
    ...
    const result = await prisma.$executeRawUnsafe(`UPDATE "Submission" SET "backHeight" = 'Medium' WHERE "backHeight" = 'Standard'`);
    ...
    try {
        await prisma.$executeRawUnsafe(`ALTER TYPE "BackHeight" RENAME VALUE 'Standard' TO 'Standard_DEPRECATED'`);

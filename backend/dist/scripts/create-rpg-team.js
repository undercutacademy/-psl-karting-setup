...
async function main() {
    ...
    const copied = {
        formConfig: (hotz.formConfig ?? client_1.Prisma.JsonNull),
        dropdownOptions: (hotz.dropdownOptions ?? client_1.Prisma.JsonNull),
        customLabels: (hotz.customLabels ?? client_1.Prisma.JsonNull),
    };

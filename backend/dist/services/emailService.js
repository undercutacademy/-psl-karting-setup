...
exports.sendManagerNotificationEmail = sendManagerNotificationEmail;
exports.sendManagerNotificationEmailBatch = sendManagerNotificationEmailBatch;
exports.sendManagerWelcomeEmail = sendManagerWelcomeEmail;
...
function buildSubmissionNotificationHtml(userName, submission, hasPhotoAttachment) {
    const val = (v) => v || '-';
    ...
    const weatherEntries = [
        ['Temperature', (0, weather_1.formatTemp)(submission.weatherTempC)],
        ['Humidity', (0, weather_1.formatHumidity)(submission.weatherHumidityPct)],
        ['Pressure', (0, weather_1.formatPressure)(submission.weatherPressureHpa)],
    ];
...
async function sendUserConfirmationEmail(userEmail, userName, submission) {
...
function buildDashPhotoAttachments(submission) {
    const parsed = parsePhotoDataUrl(submission.dashSummaryPhoto);
    if (!parsed)
        return { attachments: undefined, hasPhoto: false };
    return {
        attachments: [
            {
...
async function sendManagerNotificationEmail(managerEmail, userName, submission) {
...
async function sendManagerNotificationEmailBatch(managerEmails, userName, submission) {
...
async function sendManagerWelcomeEmail(managerEmail, password, teamSlug, teamName, teamBranding) {

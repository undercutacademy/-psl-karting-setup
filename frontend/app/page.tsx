        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden p-8">
            ...
            <div className="relative z-10 w-full max-w-md text-center">
                ...
                <div className="grid gap-4">
                    ...
                    {/* Rolison Performance Group - private */}
                    <button
                        onClick={() => setPrivateModal('Rolison Performance Group')}
                        onMouseEnter={() => setHoveredLogo('/RPG_Logo.png')}
                        onMouseLeave={() => setHoveredLogo(null)}
                        className="group relative flex items-center justify-between p-4 rounded-xl border border-gray-700/50 bg-gray-900/80 hover:bg-gray-800 hover:border-pink-500 hover:shadow-[0_0_20px_rgba(236,0,140,0.3)] transition-all duration-300 hover:scale-[1.02] cursor-pointer text-left"
                    >
                        <span className="font-bold text-lg text-gray-200 group-hover:text-white transition-colors">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-500 group-hover:text-pink-500 group-hover:translate-x-1 transition-all text-xl">
                                →
                            </span>
                        </div>
                    </button>
